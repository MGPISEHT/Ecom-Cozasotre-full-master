        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between ">
                    <h5 class="card-title fw-semibold mb-4 ">View Payments</h5>
                ...
                <div class="card mb-0 mt-3" <!-- Table to display categories -->
                    <table class="table table-bordered  ">
                        ...
                        <tbody>
                            <!--  Get payments or view payments -->
                            <?php global $conn;
                            try {
                                $sql = "SELECT order_id, payment_method, amount, payment_status, transaction_id, created_at FROM payments";
                            ...
                            <?php if (!empty($payments)): ?>
                                <?php foreach ($payments as $pay): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($pay['order_id'] ?? ''); ?></td>
                                            ...
                                            <div class="dropdown show">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <button class="dropdown-item text-info" data-toggle="modal"
                                                        data-target="#editeCategoryModal<?php echo htmlspecialchars($pay['id'] ?? ''); ?>"
