...
<body>
    <div class="modal fade" id="addModalOrder" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Add Orders</h5>
                            ...
                            <div class="card mb-0">
                                <div class="container-fluid">
                                    ...
                                    <form action="function.php" method="post" enctype="multipart/form-data">
                                        <!-- Product Name -->
                                        <div class="mb-3">
                                            <label for="proName" class="form-label">Order Name</label>
