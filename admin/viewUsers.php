            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-danger text-white" data-toggle="modal" data-target="#addUserModal">Add
                            Users</button>
                    </div>
                                                ...
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        ...
                                                        <button class="dropdown-item text-info" data-toggle="modal"
                                                            data-target="#editUserModal<?php echo htmlspecialchars($user['id'] ?? ''); ?>"
                                                            class="btn btn-sm btn-primary">Edit <svg
                                                        ...
                                                        <a href="function.php?delete_user=<?php echo htmlspecialchars($user['id']); ?>"
